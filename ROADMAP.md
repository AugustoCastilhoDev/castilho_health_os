...
Última atualização: 2026-07-29 (Tela de administração de usuários no frontend — CRUD completo, incluindo os campos de prescritor da Memed — verificada ao vivo)
...
8. **Editor de rich-text para o prontuário** — hoje é uma `<textarea>` simples; nenhuma biblioteca escolhida ainda.
